...
class ShapeIndex:
    ...
    def is_empty(self) -> bool: ...
    def num_edges(self) -> int: ...
    def contains_point(self, point: S2Point) -> bool:
        """Whether the indexed geometry contains the point (semi-open vertex model)."""
        ...

    def containing_shape_ids(self, point: S2Point) -> list[int]:
...
class S2Builder:
    ...
    def __init__(self, *, snap_level: int | None = None) -> None:
        """Create a builder. Pass `snap_level` to snap vertices to S2 cell centers."""
        ...
